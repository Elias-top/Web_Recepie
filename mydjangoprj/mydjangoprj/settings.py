...
SECRET_KEY = 'django-insecure-b23ur7@v!*h)v66y=a5=-na3=^hgy*pm+8+#d$5xvk6qtznmq4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1','193.108.115.147']
...
# Путь на сервере, куда будут загружаться медиафайлы
